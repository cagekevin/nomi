export const zhSettings = {
  ...
  general: {
    ...
    diagnostics: {
      title: '诊断',
      logLevel: '日志级别',
      logLevelHint: '遇到问题时切到 DEBUG 重跑一次，日志会记下 IPC 调用细节，方便定位。',
      logLevels: { DEBUG: '详细', INFO: '常规', WARN: '警告', ERROR: '错误' },
      preview: '日志预览',
      previewHint: '崩溃日志与运行日志合并展示。导出时打包为 zip，内含版本、系统等诊断信息，可直接发给我们。',
      empty: '还没有日志。先在应用里做一次操作，再回来刷新。',
      refresh: '刷新',
      copy: '复制',
      copied: '已复制',
      export: '导出诊断包',
...
export const enSettings = {
  ...
  general: {
    ...
    diagnostics: {
      title: 'Diagnostics',
      logLevel: 'Log level',
      logLevelHint: 'When something breaks, switch to DEBUG and rerun — IPC call details are recorded for easier diagnosis.',
      logLevels: { DEBUG: 'Verbose', INFO: 'Normal', WARN: 'Warning', ERROR: 'Error' },
      preview: 'Log preview',
      previewHint: 'Crash and runtime logs shown together. Export zips them with version, system, and other diagnostics — send it to us as is.',
      empty: 'No logs yet. Do something in the app, then refresh.',
      refresh: 'Refresh',
      copy: 'Copy',
      copied: 'Copied',
      ...
      noBridge: 'Diagnostics are unavailable in this environment.',
      merged: '(crash + runtime merged)',
    },
  },
  file: {
    title: 'File & saving',
