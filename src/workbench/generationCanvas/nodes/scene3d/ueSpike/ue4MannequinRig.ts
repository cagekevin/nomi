...
import { degreesToRadians, getBodyTypePoseLimit } from "./mannequinPose";


export const UE4_MANNEQUIN_MODEL_URL = new URL("../../../../../assets/ue-mannequin-retopology.glb", import.meta.url).href
