...
| [2026-08-10-decouple-ipc-runtime.md](2026-08-10-decouple-ipc-runtime.md) | **解耦 IPC 字符串 + runtime 百货层**：A(IPC 常量化 `ipcChannels.ts`，全仓收敛)✅ / B(类型归位断 catalog 反向依赖，barrel 保留)✅ | ✅ |
