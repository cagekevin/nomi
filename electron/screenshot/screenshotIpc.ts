...
export function registerScreenshotIpc(): void {
  ipcMain.handle("nomi:screenshot:get", async () => {
  ...
  ipcMain.handle("nomi:screenshot:set", async (_event, payload) => {
  ...
  ipcMain.handle("nomi:screenshot:open-permission-settings", async () => {
  ...
  if (process.env.NOMI_E2E === "1") {
    ipcMain.handle("nomi:screenshot:e2e-capture", async () => {
  ...
  ipcMain.handle("nomi:screenshot:set-project", async (_event, payload) => {
